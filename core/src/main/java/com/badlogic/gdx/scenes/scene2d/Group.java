...
public class Group extends Actor implements Cullable {
    ...
    protected final Affine2 worldTransform = new Affine2();
    protected final Matrix4 computedTransform = new Matrix4();
    protected final Matrix4 oldTransform = new Matrix4();
    boolean transform = true;
    protected @Null Rectangle cullingArea;
